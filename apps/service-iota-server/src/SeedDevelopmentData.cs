...
using ServiceIota.Infrastructure;
using ServiceIota.Infrastructure.Models;

namespace ServiceIota;
...
public class SeedDevelopmentData
{
    ...
    {
        var context = serviceProvider.GetRequiredService<ServiceIotaDbContext>();

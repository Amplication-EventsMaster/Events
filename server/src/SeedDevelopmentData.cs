...
using OrderService_6.Infrastructure;
using OrderService_6.Infrastructure.Models;

namespace OrderService_6;
...
public class SeedDevelopmentData
{
    ...
    {
        var context = serviceProvider.GetRequiredService<OrderService_6DbContext>();
